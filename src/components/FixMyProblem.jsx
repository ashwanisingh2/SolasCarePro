...
const issues = [
  ...
  ['Microphone not working', Mic, 'detect-services', 'quick-audio-fix', 'repair-file-permissions'],
  ...
  ['Webcam not working', Video, 'scan-drivers', 'scan-drivers', 'repair-file-permissions'],
  ...
  ['Administrator access issues', LockKeyhole, 'detect-services', 'repair-file-permissions', 'repair-registry-permissions'],
